...
//                 // style.setAttribute('media', 'print')//whether this stylesheet only should apply to print - doesn't render it to a page - prevents seeing the result on opening a page
